<div x-data="reservationWizard()" class="py-12 px-12">
  <div class="w-full bg-white dark:bg-gray-800 rounded-md border-2 shadow-md text-black p-6 mt-2">
    ...
    <form action="/admin/reservations/store" method="POST" class="w-full mx-auto" id="reservation-form" @submit.prevent="if(step === 1) step = 2; else $el.submit()">
      <?= csrf_token() ?>
         ...
         <div class="flex flex-col gap-2 lg:flex-row">
                <div class="w-full lg:w-1/2">
                    <div class="mb-4">
                        ...
                        <select 
                            ...
                            selectedCar = id && window.carsData[id] ? { id: id, ...window.carsData[id] } : null;
                            ">
                ...
                <div class="w-full lg:w-1/2">
                   ...
                   <div  x-data="{ 
                    ...
                    <input type="hidden" name="price_per_day" :value="selectedCar ? selectedCar.price : ''">
        ...
        <div class="flex flex-col-reverse gap-6 lg:flex-row">
            ...
            <div class="w-full lg:w-1/2">
                <div class="mb-4">
                    ...
                    <input type="text" id="payment_status" name="payment_status" value="pending" class="shadow border rounded w-full py-2 px-3" />
                </div>
