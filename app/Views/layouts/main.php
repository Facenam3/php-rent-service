...
<body>
    <nav class="bg-white border-gray-200 dark:bg-gray-800">
       ...
       <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
            <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:border-gray-700">
                ...
                <!-- Login/Register inside dropdown (visible on small screens) -->
                <li class="md:hidden mt-2">
                    <a href="{{ route('login') }}" class="block text-sm font-medium text-white bg-orange-600 hover:bg-orange-700 px-4 py-2 rounded-md mb-2">
                        Login
                    </a>
                    <a href="{{ route('register') }}" class="block text-sm font-medium text-white bg-orange-600 hover:bg-orange-700 px-4 py-2 rounded-md">
                        Register
                    </a>
                </li>
            </ul>
        ...
        <div class="hidden md:flex items-center md:order-2 space-x-4">
            <a href="{{ route('login') }}" class="text-sm font-medium text-white bg-orange-600 hover:bg-orange-700 px-4 py-2 rounded-md">
                Login
            </a>
            <a href="{{ route('register') }}" class="text-sm font-medium text-white bg-orange-600 hover:bg-orange-700 px-4 py-2 rounded-md">
                Register
            </a>
        </div>
    </nav>
    ...
    <footer class="bg-white  rounded-sm shadow-sm dark:bg-gray-800 ">
