...
ALTER TABLE users ADD COLUMN oauth_uid TEXT DEFAULT NULL;
...
ALTER TABLE users ADD COLUMN created DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE users ADD COLUMN modified DATETIME DEFAULT CURRENT_TIMESTAMP;